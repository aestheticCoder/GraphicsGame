...
export class Controls {
    ...
    constructor(canvas, scene) {
        ...
        birdseyeBtn.addEventListener('click', (e) => this.scene.resetBirdEye() );

        //Play View Button
        const playviewBtn = document.getElementById('playview-btn');
        playviewBtn.addEventListener('click', (e) => this.scene.resetPlayView() );
